    ...
    if (Object.keys(filterData).length > 0) {
        andConditions.push({
            AND: Object.keys(filterData).map(key => {
                if (StudentEnrolledCourse_constant_1.studentEnrolledCourseRelationalFields.includes(key)) {
                    return {
                        [StudentEnrolledCourse_constant_1.studentEnrolledCourseRelationalFieldsMapper[key]]: {
                            id: filterData[key],
                        },
                    };
                }
