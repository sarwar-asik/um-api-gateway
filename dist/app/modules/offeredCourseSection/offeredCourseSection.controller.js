...
const insertDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = req.body;
    const result = yield offeredCourseSection_service_1.OfferedCourseSectionService.insertDB(data);
...
const getAllDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield offeredCourseSection_service_1.OfferedCourseSectionService.getAllDb();
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.CREATED,
        success: true,
...
exports.OfferedCourseSectionController = { insertDB, getAllDB };
