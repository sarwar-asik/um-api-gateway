...
exports.OfferedCourseClassSchedulesUtils = void 0;
...
const checkFacultyAvailable = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const alreadyFacultyAssigned = yield prisma_1.default.offeredCourseClassSchedule.findMany({
        where: {
            dayOfWeek: data === null || data === void 0 ? void 0 : data.dayOfWeek,
            room: {
                id: data === null || data === void 0 ? void 0 : data.roomId
            }
        }
    });
...
exports.OfferedCourseClassSchedulesUtils = { checkRoomAvailable, checkFacultyAvailable };
